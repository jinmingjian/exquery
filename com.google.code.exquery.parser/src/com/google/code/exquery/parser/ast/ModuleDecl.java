...
/**
 *<b>
 *<li>Rule 10:  ModuleDecl ::= module namespace NCName EQUAL URILiteral Separator
 *</b>
 */
public class ModuleDecl extends ASTNode implements IModuleDecl
{
    ...
    public ModuleDecl(IToken leftIToken, IToken rightIToken,
