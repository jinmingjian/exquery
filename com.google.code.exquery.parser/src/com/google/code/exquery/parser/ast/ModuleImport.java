...
/**
 *<b>
 *<li>Rule 56:  ModuleImport ::= import module URILiteral AtURILiteralSpecifierOpt
 *</b>
 */
public class ModuleImport extends ASTNode implements IModuleImport
{
    ...
    public ModuleImport(IToken leftIToken, IToken rightIToken,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof ModuleImport)) return false;
        if (! super.equals(o)) return false;
        ModuleImport other = (ModuleImport) o;
