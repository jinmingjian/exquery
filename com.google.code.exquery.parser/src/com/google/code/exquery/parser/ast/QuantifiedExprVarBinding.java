...
/**
 *<b>
 *<li>Rule 119:  QuantifiedExprVarBinding ::= DOLLAR VarName TypeDeclarationOpt in ExprSingle
 *</b>
 */
public class QuantifiedExprVarBinding extends ASTNode implements IQuantifiedExprVarBinding
{
    ...
    public QuantifiedExprVarBinding(IToken leftIToken, IToken rightIToken,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof QuantifiedExprVarBinding)) return false;
        if (! super.equals(o)) return false;
        QuantifiedExprVarBinding other = (QuantifiedExprVarBinding) o;
