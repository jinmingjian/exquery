...
/**
 *<b>
 *<li>Rule 340:  TextTest ::= text LEFTPAREN RIGHTPAREN
 *</b>
 */
public class TextTest extends ASTNode implements ITextTest
{
    ...
    public TextTest(IToken leftIToken, IToken rightIToken,
                    ASTNodeToken _text,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof TextTest)) return false;
        if (! super.equals(o)) return false;
        TextTest other = (TextTest) o;
