...
/**
 *<b>
 *<li>Rule 73:  EnclosedExpr ::= LEFTBRACE Expr RIGHTBRACE
 *</b>
 */
public class EnclosedExpr extends ASTNode implements IEnclosedExpr
{
    ...
    public EnclosedExpr(IToken leftIToken, IToken rightIToken,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof EnclosedExpr)) return false;
        if (! super.equals(o)) return false;
        EnclosedExpr other = (EnclosedExpr) o;
