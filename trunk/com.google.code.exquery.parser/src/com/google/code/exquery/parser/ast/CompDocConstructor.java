...
/**
 *<b>
 *<li>Rule 299:  CompDocConstructor ::= document LEFTBRACE Expr RIGHTBRACE
 *</b>
 */
public class CompDocConstructor extends ASTNode implements ICompDocConstructor
{
    ...
    public ASTNodeToken getdocument() { return _document; }
    ...
    public CompDocConstructor(IToken leftIToken, IToken rightIToken,
                              ASTNodeToken _document,
                              ...
                              ASTNodeToken _RIGHTBRACE)
    {
        ...
        ((ASTNode) _document).setParent(this);
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof CompDocConstructor)) return false;
        if (! super.equals(o)) return false;
        CompDocConstructor other = (CompDocConstructor) o;
        if (! _document.equals(other._document)) return false;
    ...
    public int hashCode()
    {
        ...
        hash = hash * 31 + (_document.hashCode());
