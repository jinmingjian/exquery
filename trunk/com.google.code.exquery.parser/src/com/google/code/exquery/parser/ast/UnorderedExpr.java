...
/**
 *<b>
 *<li>Rule 255:  UnorderedExpr ::= unordered LEFTBRACE Expr RIGHTBRACE
 *</b>
 */
public class UnorderedExpr extends ASTNode implements IUnorderedExpr
{
    ...
    public UnorderedExpr(IToken leftIToken, IToken rightIToken,
                         ...
                         ASTNodeToken _RIGHTBRACE)
    {
        ...
        ((ASTNode) _unordered).setParent(this);
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof UnorderedExpr)) return false;
        if (! super.equals(o)) return false;
        UnorderedExpr other = (UnorderedExpr) o;
        if (! _unordered.equals(other._unordered)) return false;
    ...
    public int hashCode()
    {
        ...
        hash = hash * 31 + (_unordered.hashCode());
