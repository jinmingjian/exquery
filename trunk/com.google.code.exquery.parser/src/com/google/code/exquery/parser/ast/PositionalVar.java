...
/**
 *<b>
 *<li>Rule 97:  PositionalVar ::= at DOLLAR VarName
 *</b>
 */
public class PositionalVar extends ASTNode implements IPositionalVar
{
    ...
    public PositionalVar(IToken leftIToken, IToken rightIToken,
                         ASTNodeToken _at,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof PositionalVar)) return false;
        if (! super.equals(o)) return false;
        PositionalVar other = (PositionalVar) o;
